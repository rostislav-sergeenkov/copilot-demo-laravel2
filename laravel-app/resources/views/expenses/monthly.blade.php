...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <button onclick="window.location.href='{{ route('expenses.monthly', ['month' => now()->format('Y-m'), 'category' => $selectedCategory]) }}'"
...
<div class="date-navigation card">
    <button onclick="window.location.href='{{ route('expenses.monthly', ['month' => $month->copy()->subMonth()->format('Y-m'), 'category' => $selectedCategory]) }}'"
        class="date-nav-btn"
    ...
    <button onclick="window.location.href='{{ route('expenses.monthly', ['month' => $month->copy()->addMonth()->format('Y-m'), 'category' => $selectedCategory]) }}'"
        class="date-nav-btn"
